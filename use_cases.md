...
## UC01 - Add software to the NFDI4Energy research software registry
|||
|---|---|
...
## UC02 - Add simulation model to the NFDI4Energy research software registry
|||
|---|---|
...
## UC03 - Search for simulation software
|||
|---|---|
...
## UC04 - Compare simulation software and models
|||
|---|---|
...
## UC05 - Find best-suited co-simulation framework
|||
|---|---|
...
## UC06 - Find and reuse existing co-simulation scenarios
|||
|---|---|
...
## UC07 - Find simulation model and data for co-simulation
|||
|---|---|
...
## UC08 - Creation of simulation scenarios
|||
|---|---|
...
## UC09 - Guided creation of simulation scenario based on research goal
|||
|---|---|
...
## UC10 - Sharing the results of a co-simulation FAIRly
|||
|---|---|
...
## UC11 - Investigating and reproducing the results of a co-simulation
|||
|---|---|
...
## UC12 - Automated execution of a simulation scenario
|||
|---|---|
